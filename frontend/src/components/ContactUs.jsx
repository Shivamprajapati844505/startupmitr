  ...
  return (
    <div className=" py-10 lg:py-16 bg-white relative">
      ...
      <section className="px-4 md:px-10 max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
        {/* Left Content */}
        <div className="flex-1 w-full space-y-6 px-6 py-10 lg:py-20 rounded-xl bg-gradient-to-r from-indigo-900 via-sky-600 to-sky-700 h-full">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center gap-4">
              <div className="bg-purple-100 text-indigo-900 p-3 rounded-full flex-shrink-0">
                <FaPhoneAlt />
              </div>
              <div>
        ...
        {/* Right Form */}
        <div className="flex-1 w-full bg-white p-6 sm:p-8 shadow-xl rounded-xl text-indigo-900 h-full">
