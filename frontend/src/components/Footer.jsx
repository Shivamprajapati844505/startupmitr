...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-tr from-gray-100 to-gray-300">
      <div className="container mx-auto px-6 md:px-20 py-8 grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-20">
        {/* Logo & About */}
        <div className="flex flex-col items-center lg:items-start">
          <img src={logo} alt="MonkClick Logo" className="h-18 lg:h-22 w-auto mb-6" />
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-sm hidden sm:block">
        ...
        <div className="text-center">
          ...
          <ul className="flex flex-wrap justify-center gap-4 text-gray-700 text-sm sm:text-base">
            <li>
              <a
                href="/"
                className="text-indigo-900 hover:text-sky-700 hover:scale-105 transition-colors duration-300 font-semibold"
              >
                Home
              </a>
            </li>
            <li>
              <a
                href="/categories"
                className="text-indigo-900 hover:text-sky-700 transition-colors duration-300 font-semibold"
              >
                Category
              </a>
            </li>
          ...
          <div className="flex justify-center space-x-6 mt-2 lg:mt-10">
            <a
              href=""
      ...
      <div className=" py-4 text-center text-sm text-white bg-indigo-900 px-6 md:px-20">
        <div>
          © {new Date().getFullYear()} Startup Mitr. All rights reserved
        </div>
      </div>
    </footer>
  );
