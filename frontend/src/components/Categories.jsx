      ...
      {preview && (
        <div className="flex justify-center mt-12">
          <button
            ...
            className="flex items-center gap-2 text-white hover:bg-indigo-900
            hover:scale-105 bg-sky-700 font-semibold text-sm sm:text-base px-6 py-3 rounded-full shadow transition"
          >
            View All Categories
